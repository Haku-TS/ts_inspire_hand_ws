...
# データ定義
data_sheet = [
    ("小指指先（末端）触覚データ", 3000, 18, (3, 3), "fingerone_tip_touch"),      # 小指指先（末端）触覚データ
    ("小指指先触覚データ", 3018, 192, (12, 8), "fingerone_top_touch"),            # 小指指先触覚データ
    ("小指指腹触覚データ", 3210, 160, (10, 8), "fingerone_palm_touch"),           # 小指指腹触覚データ
    ("薬指指先（末端）触覚データ", 3370, 18, (3, 3), "fingertwo_tip_touch"),      # 薬指指先（末端）触覚データ
    ("薬指指先触覚データ", 3388, 192, (12, 8), "fingertwo_top_touch"),            # 薬指指先触覚データ
    ("薬指指腹触覚データ", 3580, 160, (10, 8), "fingertwo_palm_touch"),           # 薬指指腹触覚データ
    ("中指指先（末端）触覚データ", 3740, 18, (3, 3), "fingerthree_tip_touch"),    # 中指指先（末端）触覚データ
    ("中指指先触覚データ", 3758, 192, (12, 8), "fingerthree_top_touch"),          # 中指指先触覚データ
    ("中指指腹触覚データ", 3950, 160, (10, 8), "fingerthree_palm_touch"),         # 中指指腹触覚データ
    ("人差し指指先（末端）触覚データ", 4110, 18, (3, 3), "fingerfour_tip_touch"), # 人差し指指先（末端）触覚データ
    ("人差し指指先触覚データ", 4128, 192, (12, 8), "fingerfour_top_touch"),       # 人差し指指先触覚データ
    ("人差し指指腹触覚データ", 4320, 160, (10, 8), "fingerfour_palm_touch"),      # 人差し指指腹触覚データ
    ("親指指先（末端）触覚データ", 4480, 18, (3, 3), "fingerfive_tip_touch"),     # 親指指先（末端）触覚データ
    ("親指指先触覚データ", 4498, 192, (12, 8), "fingerfive_top_touch"),           # 親指指先触覚データ
    ("親指指中触覚データ", 4690, 18, (3, 3), "fingerfive_middle_touch"),          # 親指指中触覚データ
    ("親指指腹触覚データ", 4708, 192, (12, 8), "fingerfive_palm_touch"),          # 親指指腹触覚データ
    ("掌心触覚データ", 4900, 224, (14, 8), "palm_touch")                          # 掌心触覚データ
]
status_codes = {
    0: "リリース中",
    1: "把握中（キャッチ中）",
